// Special version of webpack-dev-middleware that use Meteor watch system to rebuild
// THANK YOU Tobias Koppers @sokra
// https://github.com/webpack/webpack-dev-middleware/blob/42e5778f44939cd45fedd36d7b201b3eeb357630/middleware.js

var path = Npm.require("path");
var MemoryFileSystem = Npm.require("memory-fs");
var mime = Npm.require("mime");

var state;

// constructor for the middleware
WebpackDevMiddleware = function(compiler, options) {
	if(!options) options = {};
  ...
  // The compiler will invalidate so just do nothing
  if(!options.lazy && !options.manual) {
  ...
  webpackDevMiddleware.build = function() {
    rebuild();
  };
